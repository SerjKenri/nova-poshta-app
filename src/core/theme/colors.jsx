const colorsLight = {
  ...
  departmentItemTitleBorder: "1px solid #000000",
  inputBackground: "#FFFFFF",
  parcelContainerShadow: "0 0 5px rgba(0, 0, 0, 0.3)",
  siderBorder: "1px solid #000000",
...
const colorsDark = {
  ...
  departmentItemTitleBorder: "1px solid #FFFFFF",
  inputBackground: "#6b60607d",
  parcelContainerShadow: "0 0 5px rgb(255, 255, 255)",
  siderBorder: "1px solid #ffffff",
